...
import type { UseCrudStateOptions } from "./state";
import type { CrudMethods } from "./methods";
...
export type UseCrudOptions<T, P> = UseCrudStateOptions<T, P> & Partial<CrudMethods>;
